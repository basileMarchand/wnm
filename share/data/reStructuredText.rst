...
Help about reStructuredText 
============================

.. note:: This content is entirely taken from the <sphinx-doc.org> website
...
* :role:`emphasis` -- alternate spelling for ``*emphasis*``
* :role:`strong` -- alternate spelling for ``**strong**``
* :role:`literal` -- alternate spelling for ````literal````
* :role:`subscript` -- subscript text
* :role:`superscript` -- superscript text
* :role:`title-reference` -- for titles of books, periodicals, and other
  materials
...
"Explicit markup" is used in reST for
...
* Admonitions: `attention`, `caution`, `danger`,
  ...
  `tip`, `warning` and the generic `admonition <admonitions>`.  (Most themes style only "note" and "warning" specially.)
